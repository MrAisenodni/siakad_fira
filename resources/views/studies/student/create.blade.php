                        ...
                        <form method="POST" action="{{ str_replace("/create", "", $menu->url) }}">
                            ...
                            <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s4">
                                            <p>
                                                ...
                                                <label>
                                                    <input id="gender" name="gender" type="radio" @if(old('gender')) checked @endif value="l" checked />
                                                    <span>Laki-Laki</span>
                                                </label>
                                                <label>
                                ...
                                <div id="family" class="col s12"><hr>
                                    ...
                                    {{-- Ayah/Bapak --}}
                                    <h6 class="card-title m-t-15">Identitas Ayah/Bapak</h6><hr>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s4">
                                            <p>
                                                ...
                                                <label>
                                                    <input id="father_gender" name="father_gender" type="radio" @if(old('father_gender')) checked @endif value="l" checked />
                                                    <span>Laki-Laki</span>
                                                </label>
                                                <label>
                                                    <input id="father_gender" name="father_gender" type="radio" @if(old('father_gender')) checked @endif value="p" />
                                                    <span>Perempuan</span>
                                                </label>
                                            </p>
                                        ...
                                        <div class="input-field col s2">
                                            <input id="father_home_number" type="text" placeholder="Nomor Telepon" name="father_home_number" value="{{ old('father_home_number') }}">
                                    ...
                                    {{-- Pendidikan/Pekerjaan Ayah/Bapak --}}
                                    <div class="row">
                                        <div class="input-field col s4">
                                        ...
                                        <div class="input-field col s3">
                                            <input id="father_revenue" type="text" placeholder="3.000.000" name="father_revenue" value="{{ old('father_revenue') }}">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input type="checkbox" class="" value="0" name="father_died" id="father_died" />
                                            <span>Meninggal?</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s4">
                                            <input id="mother_phone_number" type="text" placeholder="Nomor HP" name="mother_phone_number" value="{{ old('mother_phone_number') }}">
                                        ...
                                        <div class="input-field col s4">
                                            <input id="mother_home_number" type="text" placeholder="Nomor Telepon" name="mother_home_number" value="{{ old('mother_home_number') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s3">
                                            <input id="mother_revenue" type="text" placeholder="3.000.000" name="mother_revenue" value="{{ old('mother_revenue') }}">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input type="checkbox" class="" value="0" name="mother_died" id="father_died" />
                                            <span>Meninggal?</span>
                                        </div>
                                    </div>

                                    {{-- Wali --}}
                                    <h6 class="card-title m-t-15">Identitas Wali</h6><hr>
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <input id="guardian_name" type="text" placeholder="Nama Wali" name="guardian_name" value="{{ old('guardian_name') }}">
                                        ...
                                        <div class="input-field col s4">
                                            <input id="guardian_birth_place" type="text" placeholder="Tempat Lahir" name="guardian_birth_place" value="{{ old('guardian_birth_place') }}">
                                        ...
                                        <div class="input-field col s2">
                                            <input id="guardian_birth_date" class="datepicker" type="text" placeholder="dd/mm/yyyy" name="guardian_birth_date" value="{{ old('guardian_birth_date') }}">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <textarea placeholder="Alamat" id="guardian_address" class="materialize-textarea" name="guardian_address">{{ old('guardian_address') }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s4">
                                            <input id="guardian_phone_number" type="text" placeholder="Nomor HP" name="guardian_phone_number" value="{{ old('guardian_phone_number') }}">
                                            <label for="guardian_phone_number">Nomor HP</label>
                                            @error('guardian_phone_number')
                                                <div class="error">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="input-field col s4">
                                            <input id="guardian_home_number" type="text" placeholder="Nomor Telepon" name="guardian_home_number" value="{{ old('guardian_home_number') }}">
                                        ...
                                        <div class="input-field col s4">
                                            <select id="guardian_citizen" name="guardian_citizen" class="">
                                                <option value="" selected>--- SILAHKAN PILIH ---</option>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s4">
                                            <input id="guardian_last_study" type="text" placeholder="S1 Agrobisnis" name="guardian_last_study" value="{{ old('guardian_last_study') }}">
                                        ...
                                        <div class="input-field col s4">
                                            <select id="guardian_occupation" name="guardian_occupation" class="">
                                                <option value="" selected>--- SILAHKAN PILIH ---</option>
                                                @if ($occupations)
                                                    @foreach ($occupations as $occupation)
                                        ...
                                        <div class="input-field col s3">
                                            <input id="guardian_revenue" type="text" placeholder="3.000.000" name="guardian_revenue" value="{{ old('guardian_revenue') }}">
                                        ...
                                        <div class="input-field col s1">
                                            <select id="guardian_revenue_type" name="guardian_revenue_type" class="">
                                                <option value="day">/Hari</option>
                                                <option value="month" selected>/Bulan</option>
                                                <option value="year">/Tahun</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input type="checkbox" class="" value="0" name="guardian_died" id="father_died" />
                                            <span>Meninggal?</span>
                                        </div>
                                    </div>
                                </div>
                                <div id="contact" class="col s12"><hr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-field col s5">
                                            <input id="phone_number" type="text" placeholder="Nomor HP" name="phone_number" value="{{ old('phone_number') }}">
                                        ...
                                        <div class="input-field col s5">
                                            <input id="home_number" type="text" placeholder="Nomor Telepon" name="home_number" value="{{ old('home_number') }}">
