    ...
    <body>
        ...
        <table id="student" style="width: 100%">
            ...
            <tr>
                ...
                <td>Tempat dan Tanggal Lahir</td>
                <td width="2px">:</td> 
                <td>{{ $father->birth_place }}, {{ tanggal_indonesia($father->birth_date, false) }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>Nama</td>
                <td width="2px">:</td> 
                <td>@if ($father->citizen == 'wni') Warga Negara Indonesia @else Warga Negara Asing @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">27.</td>
                <td>Pendidikan</td>
                <td width="2px">:</td> 
                <td>{{ $father->last_study }}</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">28.</td>
                <td>Pekerjaan</td>
                <td width="2px">:</td> 
                <td>{{ $father->occupation->name }}</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">29.</td>
                <td>Penghasilan per Bulan</td>
                <td width="2px">:</td> 
                <td>{{ 'Rp '.format_uang($father->revenue).', 00' }}</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">30.</td>
                <td>Alamat Rumah/Nomor Telepon</td>
                <td width="2px">:</td> 
                <td>{{ $father->address }} / HP: {{ $father->phone_number }}</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">31.</td>
                <td>Masih Hidup/Sudah Meninggal</td>
                <td width="2px">:</td> 
                <td>@if ($father->died == 1) Sudah Meninggal @else Masih Hidup @endif</td>
            </tr>
            <tr><td><td><td></td></td></td></tr>
            ...
            <tr>
                ...
                <td>Tempat dan Tanggal Lahir</td>
                <td width="2px">:</td> 
                <td>{{ $mother->birth_place }}, {{ tanggal_indonesia($mother->birth_date, false) }}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>Nama</td>
                <td width="2px">:</td> 
                <td>@if ($mother->citizen == 'wni') Warga Negara Indonesia @else Warga Negara Asing @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">36.</td>
                <td>Pendidikan</td>
                <td width="2px">:</td> 
                <td>{{ $mother->last_study }}</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">37.</td>
                <td>Pekerjaan</td>
                <td width="2px">:</td> 
                <td>{{ $mother->occupation->name }}</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">38.</td>
                <td>Penghasilan per Bulan</td>
                <td width="2px">:</td> 
                <td>{{ 'Rp '.format_uang($mother->revenue).', 00' }}</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">39.</td>
                <td>Alamat Rumah/Nomor Telepon</td>
                <td width="2px">:</td> 
                <td>{{ $mother->address }} / HP: {{ $mother->phone_number }}</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">40.</td>
                <td>Masih Hidup/Sudah Meninggal</td>
                <td width="2px">:</td> 
                <td>@if ($mother->died == 1) Sudah Meninggal @else Masih Hidup @endif</td>
            </tr>
            <tr><td><td><td></td></td></td></tr>
            ...
            <tr>
                <td width="5px" class="ml-5">41.</td>
                <td>Nama</td>
                <td width="2px">:</td> 
                <td>@if ($guardian) {{ $guardian->full_name }} @else - @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">42.</td>
                <td>Tempat dan Tanggal Lahir</td>
                <td width="2px">:</td> 
                <td>@if ($guardian) {{ $guardian->birth_place }}, {{ tanggal_indonesia($guardian->birth_date, false) }} @else - @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">43.</td>
                <td>Agama</td>
                <td width="2px">:</td> 
                <td>@if ($guardian) {{ $guardian->religion->name }} @else - @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">44.</td>
                <td>Nama</td>
                <td width="2px">:</td> 
                <td>@if ($guardian) @if ($guardian->citizen == 'wni') Warga Negara Indonesia @else Warga Negara Asing @endif @else - @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">45.</td>
                <td>Pendidikan</td>
                <td width="2px">:</td> 
                <td>@if ($guardian) {{ $guardian->last_study }} @else - @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">46.</td>
                <td>Pekerjaan</td>
                <td width="2px">:</td> 
                <td>@if ($guardian) {{ $guardian->occupation->name }} @else - @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">47.</td>
                <td>Penghasilan per Bulan</td>
                <td width="2px">:</td> 
                <td>@if ($guardian) {{ 'Rp '.format_uang($guardian->revenue).', 00' }} @else - @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">48.</td>
                <td>Alamat Rumah/Nomor Telepon</td>
                <td width="2px">:</td> 
                <td>@if ($guardian) {{ $guardian->address }} / HP: {{ $guardian->phone_number }} @else - @endif</td>
            </tr>
            <tr>
                <td width="5px" class="ml-5">49.</td>
                <td>Masih Hidup/Sudah Meninggal</td>
                <td width="2px">:</td> 
                <td>@if ($guardian) @if ($guardian->died == 1) Sudah Meninggal @else Masih Hidup @endif @else - @endif</td>
            </tr>
            <tr><td><td><td></td></td></td></tr>
