                                    ...
                                    <select id="teacher" name="teacher" class="">
                                        ...
                                        @if ($teachers)
                                            @foreach ($teachers as $teacher)
                                                <option @if(old('teacher', $lesson->teacher_id) == $teacher->id) selected @endif value="{{ $teacher->id }}">[{{ $teacher->nip }}] {{ $teacher->full_name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    ...
                                    <select id="lesson" name="lesson" class="">
                                        ...
                                        @if ($mst_lessons)
                                            @foreach ($mst_lessons as $mst_lesson)
                                                <option @if(old('lesson', $lesson->lesson_id) == $mst_lesson->id) selected @endif value="{{ $mst_lesson->id }}">{{ $mst_lesson->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    ...
                                    <select id="study" name="study" class="">
                                        ...
                                        @if ($studies)
                                            @foreach ($studies as $study)
                                                <option @if(old('study', $lesson->study_year_id) == $study->id) selected @endif value="{{ $study->id }}">{{ $study->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                    ...
                                    <select id="class" name="class" class="">
                                        ...
                                        @if ($classes)
                                            @foreach ($classes as $class)
                                                <option @if(old('class', $lesson->class_id) == $class->id) selected @endif value="{{ $class->id }}">{{ $class->name }}</option>
                                            @endforeach
                                        @endif
                                    </select>
