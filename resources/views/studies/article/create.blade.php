                        ...
                        <form method="POST" action="{{ str_replace("/create", "", $menu->url) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="input-field col s6">
                                    <input id="title" type="text" placeholder="Jadwal UTS" name="title" value="{{ old('title') }}">
                                ...
                                <div class="input-field col s6">
                                    <select id="status" name="status" class="">
                                        <option @if(old('status') == 'new') selected @endif value="new" selected>Baru</option>
                                        <option @if(old('status') == 'publish') selected @endif value="publish">Terbit</option>
                                        <option @if(old('status') == 'draft') selected @endif value="draft">Arsip</option>
                                    </select>
                                ...
                                <div class="input-field col s6">
                                    <input id="author" type="text" placeholder="Safira" name="author" value="{{ old('author') }}">
