            ...
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <h5 class="card-title">{{ $menu->title }} Pulang</h5>
                        <form method="POST" action="{{ str_replace("/clockout", "", $menu->url) }}">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col s3">
                                    <label for="clock_out" class="m-t-20">Pulang</label>
                                    <div class="input-fleid">
                                        <input id="clock_out" type="hidden" name="clock_out" value="{{ old('clock_out', date('H:i', strtotime(now()))) }}">
                                        <input id="clock_out" type="text" value="{{ old('clock_out', date('H:i', strtotime(now()))) }}" disabled>
                                    </div>
                                    @error('clock_out')
                                        <div class="error">{{ $message }}</div>
                                    @enderror
